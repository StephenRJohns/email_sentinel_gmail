...
if $LAST_FAILED; then
  ...
  echo "============================================================"
  echo "  Tests assume a clean add-on state. Accumulated rules or"
  echo "  settings from previous runs will cause cascade failures"
  echo "  (S3 starter rules, S4 rule save, S16 confirmations, etc.)."
  echo ""
  ...
  echo "  run did not create rules / change settings)."
  echo "============================================================"
  echo ""
